...
<head>
    ...
    <script src="https://cdn.tiny.cloud/1/5w6wgtkz9q8erraf7kxab42t8l4e5hs4dc569ba34gf03c76/tinymce/7/tinymce.min.js" referrerpolicy="origin"></script>
        ...
        <div class="sidebar" data-background-color="dark">
            <div class="sidebar-logo">
                ...
                <div class="logo-header" data-background-color="dark">
                    <a href="index.html" class="logo"style="color: white">FlashCard Website
                    </a>
                                    ...
                                    <div class="dropdown-user-scroll scrollbar-outer">
                                        <li>
                                            <div class="user-box">
                                                ...
                                                <div class="u-text">
                                                    <h4>Hizrian</h4>
                                                    <p class="text-muted">{{auth('admin')->user()->username}}</p>
                                                    <a href="#"
                                                        class="btn btn-xs btn-secondary btn-sm">{{auth('admin')->user()->email}}</a>
                                                </div>
                                            </div>
                                        </li>
                                        <li>
